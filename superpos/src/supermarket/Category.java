...
public class Category extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), "Category", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtcat)
                            .addComponent(txtstat, 0, 157, Short.MAX_VALUE)))
                    .addGroup(jPanel3Layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            pst = (PreparedStatement) conn.prepareStatement("insert into category(categoryy,status) values(?,?)");
            pst.setString(1,category);
            pst.setString(2,status);
            pst.executeUpdate();
            
            JOptionPane.showMessageDialog(null,"Record inserted in category.");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        txtstat.setSelectedItem(d.getValueAt(selectindex,2));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            pst = (PreparedStatement) conn.prepareStatement("update category set categoryy = ? , status = ? where id = ?");
            pst.setString(1,category);
            pst.setString(2,status);
            pst.setString(3,id);
            pst.executeUpdate();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            if(dialogResult == JOptionPane.YES_OPTION){
              pst = (PreparedStatement) conn.prepareStatement("delete from category where id = ?");
              pst.setString(1, id);
              pst.executeUpdate();
