...
public class Brand extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), "Brand", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            pst = (PreparedStatement) conn.prepareStatement("insert into brand(brandd,status) values(?,?)");
            pst.setString(1,brand);
            pst.setString(2,status);
            pst.executeUpdate();
            
            JOptionPane.showMessageDialog(null,"Record inserted in brand");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            pst = (PreparedStatement) conn.prepareStatement("update brand set brandd = ? , status = ? where id = ?");
            pst.setString(1,brand);
            pst.setString(2,status);
            pst.setString(3,id);
            pst.executeUpdate();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            if(dialogResult == JOptionPane.YES_OPTION){
              pst = (PreparedStatement) conn.prepareStatement("delete from brand where id = ?");
              pst.setString(1, id);
              pst.executeUpdate();
